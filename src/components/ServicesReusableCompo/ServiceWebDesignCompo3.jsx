    ...
    return(
        ...
        <div className="flex flex-col w-full lg:flex-row mt-10 text-white">
          ...
          <div className="grid flex-grow lg:h-[30rem] md:h-[20rem] h-[30rem] w-full card  rounded-box">
             ...
             <div className=" flex md:text-lg text-md lg:hover:bg-[#2e2e61] lg:hover:translate-y-2 h-[5rem] rounded-xl p-1 md:mt-0 mt-16"><span className=" lg:w-14 lg:h-12 w-[2.5rem] h-[2rem]  rounded-full bg-[#85c4be] flex items-center justify-center mr-2">2</span>{item4}</div>

          </div>
          {/* 2nd */}
          <div className=" lg:divider-horizontal bg-white lg:w-1"></div>
          <div className="grid flex-grow lg:h-[30rem]  md:h-[20rem] h-[30rem] w-full card  rounded-box md:mt-0 mt-14 ">
